...
public class PriorityQueueExample {
	...
	public static void main(String[] args) {
		...
		/*
		 * now we call remove twice and think we should get "Go Home" first and
		 * "Do Homework" second
		 */
		...
		/*
		 * why is priority 10 listed before priority 2? It turns out that using
		 * Strings with PriorityQueue only works if the priority number is <= 9
		 * because elements are removed in a lexicographic order. The number 10
		 * starts with 1 so the element with priority 10 is removed before the
		 * element with priority 2.
		 */
	}
