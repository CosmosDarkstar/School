package textbook.ch19.worked_example_1;
 ...
 * panel with a text fields to specify the result of calculation.
 */
public class CalculatorFrame extends JFrame {
	...
	/**
	 * Creates the control panel with the text field and buttons on the frame.
	 */
	...
	class OperatorButtonListener implements ActionListener {
		...
		/**
		 * Constructs a listener whose actionPerformed method schedules an
