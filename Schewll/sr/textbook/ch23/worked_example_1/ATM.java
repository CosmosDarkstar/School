package textbook.ch23.worked_example_1;
...
public class ATM {
	...
	/**
	 * Sets the current customer number and sets state to PIN. (Precondition:
	 * state is START)
	 * 
	 * @param number
	 *            the customer number.
	...
	/**
	 * Gets the balance of the current account. (Precondition: state is
	 * TRANSACT)
	 * 
	 * @return the balance
	 */
